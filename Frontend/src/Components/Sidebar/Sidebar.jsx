            ...
            if (mail && role) {
                try {
                    ...
                    if (response.data.success) {
                        ...
                        const imageCheckResponse = await axios.get(
                        ...
                        if (imageCheckResponse.data.success) {
                            setSelectedImage(
                                `http://localhost:5001/api${imagePath}`
                            );
                        } else {
        ...
        <nav ref={sidebarRef}>
            <div className="side-logo">
                <span onClick={handleClick}>
                    <i class="bx bx-menu side-menu"></i>
                </span>
            ...
            >
                <ul>
                    ...
                    <li>
                        <img
                            src={image || selectedImage || profilePic}
                            alt="Profile"
                        />
                    </li>
                    <i
                        className={`bx ${
                            showDropdown ? "bx-chevron-up" : "bx-chevron-down"
                        }`}
                    ></i>
                </ul>
